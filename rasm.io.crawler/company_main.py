...
for supplier in suppliers:
    ...
    get_parameters = {'term': str_supplier, 'page': '1',
                      'pagesize': 49}  # pagesize: for number of retrieved records,  page: number of page, term: specific url
    try:
        ...
        print('Error: ' + str(ex))
        logging.error('Error in crawling ' + str_supplier + ' with this error: ' + str(ex))
            # if counter % 1000 == 500:
            #     print(counter)
            #     print("Sleeping...")
            #     time.sleep(8)
